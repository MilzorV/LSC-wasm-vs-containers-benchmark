# Bartholomew Site Template (LSC benchmark copy)

**Course note:** This tree is embedded in the LSC benchmark repo; run `spin up --listen 127.0.0.1:8080` and see the [parent README](../README.md).
